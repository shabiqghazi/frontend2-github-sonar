...
export default function Rank() {
    ...
    const [activeGraph, setActiveGraph] = useState("Bubble")
    ...
    useEffect(() => {
        async function getData() {
            const githubToken = 'token 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'
        ...
        <div>
            <div className="d-flex flex-column p-4 gap-4">
                ...
                <div className="d-flex flex-row pb-4">
                        ...
                        <div className="d-flex flex-column px-3 col-md-2">
                            ...
                            <div className="list-group">
                                <button onClick={() => {
                                    setActiveCommiter("")
                                    setActiveGraph("Bubble")
                                }} type="button" className={`list-group-item overflow-hidden d-flex flex-row align-items-center justify-content-between p-2 list-group-item-action ${activeGraph === "Bubble" ? "active" : ""}`}>
                                    <span>Bubble Chart</span>
                                </button>
                                <button onClick={() => {
                                    setActiveCommiter("")
                                    setActiveGraph("Bar")
                                }} type="button" className={`list-group-item overflow-hidden d-flex flex-row align-items-center justify-content-between p-2 list-group-item-action ${activeGraph === "Bar" ? "active" : ""}`}>
                                    <span>Bar Chart</span>
                                </button>
                                <button onClick={() => {
                                    setActiveCommiter("")
                                    setActiveGraph("Tree")
                                }} type="button" className={`list-group-item overflow-hidden d-flex flex-row align-items-center justify-content-between p-2 list-group-item-action ${activeGraph === "Tree" ? "active" : ""}`}>
                                    <span>Tree Chart</span>
                                </button>
                                <button onClick={() => {
                                    setActiveCommiter("")
                                    setActiveGraph("Circular")
                                }} type="button" className={`list-group-item overflow-hidden d-flex flex-row align-items-center justify-content-between p-2 list-group-item-action ${activeGraph === "Circular" ? "active" : ""}`}>
                    ...
                    <div className={`d-flex flex-column ${activeCommiter === "" ? "" : "px-3"} col`}>
                        <div className="pb-3">{activeCommiter === "" ? "Project Graph" : "Commiter Graph"}</div>
                        {activeCommiter !== ""
                            ?
                            ...
                            activeGraph === "Bubble" ?
                                <div className="card">
                                    <div className="card-header">Buble Chart</div>
                                    <div className="rounded-circle mx-auto p-2 m-3" style={{ backgroundColor: '#fceebb', border: '2px solid orange' }}>
                                        <BubbleChart data={data} width={500} height={500} />
                                    </div>
                                </div>
                                : activeGraph === "Bar" ?
                                    <div className="card">
                                        <div className="card-header">Bar Chart</div>
                                        <StackedBarChart data={data} width={500} height={500} />
                                    </div>
                                    : activeGraph === "Tree" ?
                                        <div className="card">
                                            <div className="card-header">Tree Chart</div>
                                            <RadialTreeChart data={data2} width={1000} height={1000} />
                                        </div>
                                        :
                                        <div className="card">
